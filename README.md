...
> 📄 **문서 정본**: 파이프라인 = [`docs/SPEC.md`](docs/SPEC.md) · 소스 카탈로그 = [`docs/SOURCES.md`](docs/SOURCES.md) · 출력 계약·교단 = [`docs/CONTRACT.md`](docs/CONTRACT.md) · 작업 로드맵 = [`docs/ROADMAP.md`](docs/ROADMAP.md) · 시점 핸드오프 = [`docs/SNAPSHOT.md`](docs/SNAPSHOT.md). (`CLAUDE.md`·정식 `src/`는 미작성.)
