...
def row_to_review_data(row: Row) -> ReviewData:
    ...
    try:
        return ReviewData(
            ...
            stipend_min=_optional_int(row, "stipend_min"),
            stipend_max=_optional_int(row, "stipend_max"),
            stipend_note=_optional_str(row, "stipend_note"),
            stipend_period=_optional_enum(row, "stipend_period", StipendPeriod),
            ...
            contact=_optional_str(row, "contact"),
