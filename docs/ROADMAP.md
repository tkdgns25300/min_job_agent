...
- [x] **CSU 첨부가 며칠 뒤 사라진다** 실측 2026-08-23 — 수집 때 200이던 파일이 5~7일 뒤 전부 404. 오래된 공고의 포스터가 비는 것은 결함이 아니다. 포스터를 Storage에 복사한 결정의 근거가 됐다(`config/sources.json` CSU `fetch_note` · SPEC §5.7 · REVIEW_PAGE §7)
