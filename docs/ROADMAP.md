...
> **3단계에서 지금까지 한 일**(2026-08-14~15) — 모델에게서 **변환을 뺏고**(지역·사례비·주기·마감·제목은
...
- [ ] **1단계 — 위치 한 묶음 + 사택 검산**(2026-08-16 · SPEC §5.5b·§5.5c)
  - 모델이 `region`(enum)·`city`·`address`를 **근거와 함께** 낸다. 코드는 검산만 한다 — `location`→글자 매칭은 `안동시`(11%)와 `전남광주통합특별시 북구`(그 표기 12건 중 4건이 광주인데 JEONNAM으로 오판)에서 깨진다
