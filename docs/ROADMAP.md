...
- [x] **2단계 — 자동 승인 규칙** ✅ 2026-08-17 · 실측(1주치 전량 473건 · 2026-08-23) 자동 승인 53%·사람이 볼 것 15%(2개월 환산 ≈ 560건)·자동 거절 32%(거의 전부 중복) —(`confidence` · SPEC §5.7). ⚠️ **2026-08-11 결정을 개정한다** — 옛 규칙은 "high=승격 6칸+region / medium=region 없음 / low=나머지"였고 **모두 PENDING**이었다. 새 규칙은 **검수를 사람이 봐야 답이 나오는 것만 남기고**(포스터·그림 실패·승격칸 빔 ≈ 20%) 나머지를 `APPROVED`로 만든다
