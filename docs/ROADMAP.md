...
### 1-2. 구조화 패스 (source_data → review_data)  ⏳ **3단계 진행(2026-08-14~)** — 교단 확정 완료 · 이단·`confidence`·`dedup_key`와 전량 실행이 남았다
...
> | **3단계** 마감·전량 | 규칙 판정(~~교단~~ ✅ 2026-08-16 · 이단·`dedup_key`·`confidence`) + **되돌리기 스크립트** ✅ + 진행 표시 | 규칙 테스트(무료) → 운영자가 `--all` | 규칙 0회 · 전량 3,188회 |
>
