...
### 1-2. 구조화 패스 (source_data → review_data)  ✅ **3단계 완료(2026-08-14)** — 남은 것은 이단·중복·`confidence`

> **3단계에서 한 일**(2026-08-14) — 모델에게서 **변환을 뺏고**(지역·사례비·주기·마감·제목은
...
- [x] 소량(`--dry-run --limit 20 --source KEY`) 검증 → 프롬프트 조정 → ⚠️ **전량은 운영자가 실행**(유료 API)
