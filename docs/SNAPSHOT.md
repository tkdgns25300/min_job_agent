...
**대기:**
- [ ] **최종 크롤 타깃 sign-off** ⭐ — §5 A(확정)/B(조건부)/C(드롭) 운영자 최종 승인 → **SOURCES/CONTRACT 판정 반영**(현재 PROK·gapck·kcc·나사렛·SU·bsds 드롭/휴면이 §5에만 있고 SOURCES/CONTRACT 본문엔 아직 미반영). 이후 어댑터 구현 대상 확정.
