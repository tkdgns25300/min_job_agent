...
```
  ...
  이미 결론         2건   이단·마감·운영자 거절 · 원문 소멸 · 마감 지남 — 건드리지 않는다
  저장           128건 갱신
```
| 줄 | 뜻 |
|---|---|
...
| **이미 결론** | 이단·마감·운영자가 이미 거절한 공고, 원문이 게시판에서 사라진 공고, **마감일이 지난 공고**다. 이런 글을 대표로 세우면 살아 있는 같은 자리 공고가 그 밑에 묻힌다 — 마감 지난 대표가 빠지면 교회가 새로 올린 재공고가 자리를 물려받아 공개된다 |
